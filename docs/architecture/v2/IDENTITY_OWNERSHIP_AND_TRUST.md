...
| Plugin | Plugin, Manifest, Installation, and Activation IDs remain separate | Plugin and installed-instance display names | Publisher for definition/manifest; Organization owner for scoped installation/activation | Authenticated publisher/installer/activator and governed steward | **OPEN** definition, manifest, publishing, installation, and activation authorities | Actor Context, authorization, applicable approval verification, artifact trust, compatibility, and Event evidence | Immutable Artifact/Manifest plus separately revisioned Definition/Installation/Activation | Future publishing and installation stores |
...
| Runtime Requirement / Compatibility Evidence | Separate requirement and observation IDs | Requirement/evidence display name | Publisher or Organization owner appropriate to scope | Authenticated creator and governed observer | **OPEN** requirement and observation owners | Compatibility evidence is explicitly non-authoritative and time-bounded | Exact requirement/target revisions and observation expiry | Future lifecycle stores |
| Permission Declaration / Capability Profile | Separate declaration/profile IDs | Declaration/profile display name | Publisher or Organization owner appropriate to scope | Authenticated creator and governed steward | **OPEN** declaration/profile owners | Neither is an Authorization Decision, Approval Grant, ranking, resolution, or execution authority | Revision-pinned actions, scope, constraints, and policy references | Future lifecycle stores |
...
Epic 6.0 Plugin Definitions and Installations therefore pin
`leos.artifact-trust-evidence.v1` by exact revision and require a current
`TRUSTED` outcome in reference conformance. That evidence still cannot publish,
install, activate, authorize, approve, register, resolve, or invoke the
Artifact. Generic Artifact and publishing authority remain **OPEN**.
